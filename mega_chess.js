...
let contador = 0; //utilizado en primer movimiento de la partida
...
class MovimientosPeones {
  static muevePeonNegro(tablero_general) {
    ...
    if (contador == 0) {
     ...
     for (let i = tablero_general.length - 1; i >= 0; i--) {
      for (let j = tablero_general.length - 1; j >= 0; j--) {
        //chequeo que si los peones estan en filas 2 o 3 , pueden mover 2 espacios  
        if (tablero_general[i][j] === "p" && (i == 2 || i == 3)) {
